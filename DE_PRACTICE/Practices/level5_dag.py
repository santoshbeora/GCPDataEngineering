...
# Airflow Variables
settings = Variable.get("level3_dag_airflow_variable", deserialize_json=True)
...
# Stations
station_source_object  = "target_data/stations/stations.csv"
sql_query              = "SELECT * FROM db.stations"
...
# Regions
gcs_regions_source_object = "DE_datasets/regions/regions.csv"
gcs_regions_target_object = f"target_data/regions/{extracted_date_nodash}/regions.csv"
...
# Trips
bq_temporary_extract_dataset_name = "temp_dataset"
...
gcs_trips_source_object = f"target_data/trips/{extracted_date_nodash}/*.csv"
...
with DAG(
    ...
    send_dag_success_signal = GoogleCloudStorageToGoogleCloudStorageOperator(
        ...
        source_bucket=gcs_source_data_bucket,
        source_object=f'data/signal/_SUCCESS',
        destination_bucket=gcs_source_data_bucket,
        destination_object=f'data/signal/staging/level_5_dag_sensor/{extracted_date_nodash}/_SUCCESS'
    )
